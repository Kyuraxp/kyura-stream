...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/kyuraproject'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/Kyuraxp/kyura-stream')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Kyuraxp/kyura-stream'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/kyuraproject'),     
        ],
        [
